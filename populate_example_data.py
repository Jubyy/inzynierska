...
# Importujemy modele po inicjalizacji Django
...
def create_ingredient_categories():
    ...
    categories = [
        {'name': 'Owoce', 'description': 'Świeże i suszone owoce'},
        {'name': 'Warzywa', 'description': 'Wszystkie rodzaje warzyw'},
        {'name': 'Mięso', 'description': 'Różne rodzaje mięs'},
        {'name': 'Nabiał', 'description': 'Produkty mleczne'},
        {'name': 'Pieczywo', 'description': 'Chleby, bułki, pieczywo'},
        {'name': 'Przyprawy', 'description': 'Zioła i przyprawy'},
        {'name': 'Produkty zbożowe', 'description': 'Kasze, ryże, makarony'},
        {'name': 'Tłuszcze', 'description': 'Oleje, masła, tłuszcze'},
        {'name': 'Orzechy i nasiona', 'description': 'Różne orzechy i nasiona'},
        {'name': 'Napoje', 'description': 'Soki, wody, napoje'}
    ]
...
def create_ingredients(categories, units):
    ...
    ingredients_data = [
        # Owoce
        {'name': 'Jabłko', 'category': 'Owoce', 'default_unit': 'szt', 'unit_type': 'count', 'kcal': 52},
        {'name': 'Banan', 'category': 'Owoce', 'default_unit': 'szt', 'unit_type': 'count', 'kcal': 89},
        {'name': 'Truskawki', 'category': 'Owoce', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 32},
        {'name': 'Maliny', 'category': 'Owoce', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 52},
        
        # Warzywa
        {'name': 'Marchew', 'category': 'Warzywa', 'default_unit': 'szt', 'unit_type': 'count', 'kcal': 41},
        {'name': 'Ziemniak', 'category': 'Warzywa', 'default_unit': 'szt', 'unit_type': 'count', 'kcal': 77},
        {'name': 'Cebula', 'category': 'Warzywa', 'default_unit': 'szt', 'unit_type': 'count', 'kcal': 40},
        {'name': 'Czosnek', 'category': 'Warzywa', 'default_unit': 'szt', 'unit_type': 'count', 'kcal': 149},
        {'name': 'Pomidor', 'category': 'Warzywa', 'default_unit': 'szt', 'unit_type': 'count', 'kcal': 18},
        
        # Mięso
        {'name': 'Pierś z kurczaka', 'category': 'Mięso', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 165},
        {'name': 'Mięso mielone wołowe', 'category': 'Mięso', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 250},
        {'name': 'Filet z łososia', 'category': 'Mięso', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 208},
        
        # Nabiał
        {'name': 'Mleko', 'category': 'Nabiał', 'default_unit': 'ml', 'unit_type': 'volume', 'kcal': 42},
        {'name': 'Jajko', 'category': 'Nabiał', 'default_unit': 'szt', 'unit_type': 'count', 'kcal': 155},
        {'name': 'Ser żółty', 'category': 'Nabiał', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 402},
        {'name': 'Jogurt naturalny', 'category': 'Nabiał', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 60},
        
        # Pieczywo
        {'name': 'Chleb pszenny', 'category': 'Pieczywo', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 265},
        {'name': 'Bułka', 'category': 'Pieczywo', 'default_unit': 'szt', 'unit_type': 'count', 'kcal': 319},
        
        # Przyprawy
        {'name': 'Sól', 'category': 'Przyprawy', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 0},
        {'name': 'Pieprz czarny', 'category': 'Przyprawy', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 251},
        {'name': 'Bazylia', 'category': 'Przyprawy', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 23},
        {'name': 'Oregano', 'category': 'Przyprawy', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 306},
        
        # Produkty zbożowe
        {'name': 'Ryż biały', 'category': 'Produkty zbożowe', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 130},
        {'name': 'Makaron spaghetti', 'category': 'Produkty zbożowe', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 158},
        {'name': 'Kasza gryczana', 'category': 'Produkty zbożowe', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 343},
        {'name': 'Mąka pszenna', 'category': 'Produkty zbożowe', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 364},
        
        # Tłuszcze
        {'name': 'Olej rzepakowy', 'category': 'Tłuszcze', 'default_unit': 'ml', 'unit_type': 'volume', 'kcal': 884},
        {'name': 'Masło', 'category': 'Tłuszcze', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 717},
        {'name': 'Oliwa z oliwek', 'category': 'Tłuszcze', 'default_unit': 'ml', 'unit_type': 'volume', 'kcal': 884},
        
        # Orzechy i nasiona
        {'name': 'Orzechy włoskie', 'category': 'Orzechy i nasiona', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 654},
        {'name': 'Migdały', 'category': 'Orzechy i nasiona', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 579},
        {'name': 'Nasiona chia', 'category': 'Orzechy i nasiona', 'default_unit': 'g', 'unit_type': 'weight', 'kcal': 486},
        
        # Napoje
        {'name': 'Woda', 'category': 'Napoje', 'default_unit': 'ml', 'unit_type': 'volume', 'kcal': 0},
        {'name': 'Sok pomarańczowy', 'category': 'Napoje', 'default_unit': 'ml', 'unit_type': 'volume', 'kcal': 45},
    ]
...
def create_users():
    ...
    users_data = [
        ...
        {'username': 'admin', 'email': 'admin@example.com', 'password': 'adminpassword', 'first_name': 'Admin', 'last_name': 'User', 'is_staff': True, 'is_superuser': True},
    ]
    ...
    if 'testuser' in created_users and 'annanowak' in created_users:
        UserFollowing.objects.get_or_create(
            user=created_users['testuser'],
            followed_user=created_users['annanowak']
        )
